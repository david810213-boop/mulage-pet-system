...
public class GlobalApiExceptionHandler {
    ...
    @ExceptionHandler(com.petgrooming.pet_system.exception.BusinessException.class)
    public ResponseEntity<?> handleDomainBusinessError(com.petgrooming.pet_system.exception.BusinessException ex) {
    ...
    public ResponseEntity<?> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(Map.of("message", "這筆資料跟其他紀錄有關聯，無法執行這個操作，請聯絡工程人員協助確認"));
    }
}
